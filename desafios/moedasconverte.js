...
button.addEventListener("click", function () {
    ...
    if (select1.value == "1") {
        img.src = "./assets.jpeg/brazil.png";
    }
    else if (select1.value == "5.24") {
        img.src = "./assets.jpeg/estados.png";
    }
    else if (select1.value == "7") {
        img.src = "./assets.jpeg/europe.png";
    }
    ...
    if (select2.value == "1") {
        img2.src = "./assets.jpeg/brazil.png";
    }
    else if (select2.value == "5.24") {
        img2.src = "./assets.jpeg/estados.png";
    }
    else if (select2.value == "7") {
        img2.src = "./assets.jpeg/europe.png";
    }
